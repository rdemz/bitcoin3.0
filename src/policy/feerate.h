...
const std::string CURRENCY_UNIT = "BT3"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BT3_KVB,      //!< Use BT3/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BT3_KVB) const;
