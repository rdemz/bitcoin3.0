...
{
    // Windows: C:\Users\Username\AppData\Roaming\Bitcoin 3.0
    // macOS: ~/Library/Application Support/Bitcoin 3.0
    // Unix-like: ~/.bitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bitcoin 3.0";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/Bitcoin 3.0";
#else
    // Unix-like
