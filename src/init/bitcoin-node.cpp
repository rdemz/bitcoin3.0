...
class Bitcoin 3.0NodeInit : public interfaces::Init
{
public:
    Bitcoin 3.0NodeInit(node::NodeContext& node, const char* arg0)
        : m_node(node),
...
{
    auto init = std::make_unique<init::Bitcoin 3.0NodeInit>(node, argc > 0 ? argv[0] : "");
