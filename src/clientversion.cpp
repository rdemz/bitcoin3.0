...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Bitcoin 3.0 Core copyright is not removed by accident
    if (copyright_devs.find("Bitcoin 3.0 Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Bitcoin 3.0 Core developers";
    }
