...
//! Entry point for Bitcoin 3.0Application tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &Bitcoin 3.0Application::windowShown, this, &AppTests::guiTests);
...
//! Entry point for Bitcoin 3.0GUI tests.
void AppTests::guiTests(Bitcoin 3.0GUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &Bitcoin 3.0GUI::consoleShown, this, &AppTests::consoleTests);
