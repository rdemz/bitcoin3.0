// Copyright (c) 2009-2018 The Bitcoin 3.0 Core developers
...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseBitcoin 3.0URI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseBitcoin 3.0URI("bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());
