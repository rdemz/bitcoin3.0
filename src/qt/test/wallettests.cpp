// Copyright (c) 2015-2022 The Bitcoin 3.0 Core developers
                  ...
                  QMessageBox::StandardButton confirm_type = QMessageBox::Yes)
{
    ...
    entry->findChild<Bitcoin 3.0AmountField*>("payAmount")->setValue(amount);
...
void CompareBalance(WalletModel& walletModel, CAmount expected_balance, QLabel* balance_label_to_check)
{
    ...
    QString balanceComparison = Bitcoin 3.0Units::formatWithUnit(unit, expected_balance, false, Bitcoin 3.0Units::SeparatorStyle::ALWAYS);
...
void TestGUI(interfaces::Node& node, const std::shared_ptr<CWallet>& wallet)
{
    ...
    // Amount input
    Bitcoin 3.0AmountField* amountInput = receiveCoinsDialog.findChild<Bitcoin 3.0AmountField*>("reqAmount");
