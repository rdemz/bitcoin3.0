This directory contains the source code for the Bitcoin 3.0 Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the Bitcoin 3.0 UI.
...
* UI elements like Bitcoin 3.0AmountField, which inherit from QWidget.
* `bitcoinstrings.cpp`: automatically generated
* `bitcoinunits.(h/cpp)`: BT3 / mBT3 / etc. handling
* `callback.h`
...
9. You're all set! Start developing, building, and debugging the Bitcoin 3.0 Core GUI
