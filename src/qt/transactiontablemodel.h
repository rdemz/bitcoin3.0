...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, Bitcoin 3.0Units::SeparatorStyle separators=Bitcoin 3.0Units::SeparatorStyle::STANDARD) const;
