...
/**
  Bitcoin 3.0 GUI main class. This class represents the main window of the Bitcoin 3.0 UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class Bitcoin 3.0GUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit Bitcoin 3.0GUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~Bitcoin 3.0GUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, Bitcoin 3.0Unit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitcoin 3.0 Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(Bitcoin 3.0Unit newUnits);
