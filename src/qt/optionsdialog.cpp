      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->openBitcoin 3.0ConfButton->setToolTip(ui->openBitcoin 3.0ConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new Bitcoin 3.0Units(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBT3ontrols);
...
void OptionsDialog::on_openBitcoin 3.0ConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoin 3.0Conf())
