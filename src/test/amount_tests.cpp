// Copyright (c) 2016-2021 The Bitcoin 3.0 Core developers
...
BOOST_AUTO_TEST_CASE(BinaryOperatorTest)
{
    ...
    BOOST_CHECK(b >= a);
    BOOST_CHECK(b >= b);
    // a should be 0.00000002 BT3/kvB now
    a += a;
    BOOST_CHECK(a == b);
}
...
BOOST_AUTO_TEST_CASE(ToStringTest)
{
    CFeeRate feeRate;
    feeRate = CFeeRate(1);
    BOOST_CHECK_EQUAL(feeRate.ToString(), "0.00000001 BT3/kvB");
    BOOST_CHECK_EQUAL(feeRate.ToString(FeeEstimateMode::BT3_KVB), "0.00000001 BT3/kvB");
