...
The Bitcoin 3.0 Core daemon can be configured to act as a trusted "border
...
The ZeroMQ feature in Bitcoin 3.0 Core requires the ZeroMQ API >= 4.0.0
...
using. Bitcoin 3.0d appends an up-counting sequence number to each
