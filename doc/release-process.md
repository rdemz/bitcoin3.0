...
Checkout the Bitcoin 3.0 Core version you'd like to build:
...
- Update other repositories and websites for new version
  ...
  - bitcoincore.org RPC documentation update
      ...
      - Install the new Bitcoin 3.0 Core release
...
- Announce the release:
  ...
  - Bitcoin 3.0 Core announcements list https://bitcoincore.org/en/list/announcements/join/

  - Bitcoin 3.0 Core Twitter https://twitter.com/bitcoincoreorg
