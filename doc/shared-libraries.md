...
The purpose of this library is to make the verification functionality that is critical to Bitcoin 3.0's consensus available to other applications, e.g. to language bindings.
...
- [NBitcoin 3.0](https://github.com/MetacoSA/NBitcoin 3.0/blob/5e1055cd7c4186dee4227c344af8892aea54faec/NBitcoin 3.0/Script.cs#L979-#L1031) (.NET Bindings)
