...
-- | -- | --
Windows | `%APPDATA%\Bitcoin 3.0\` | `C:\Users\username\AppData\Roaming\Bitcoin 3.0\bitcoin.conf`
Linux | `$HOME/.bitcoin/` | `/home/username/.bitcoin/bitcoin.conf`
macOS | `$HOME/Library/Application Support/Bitcoin 3.0/` | `/Users/username/Library/Application Support/Bitcoin 3.0/bitcoin.conf`
