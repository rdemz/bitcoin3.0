...
Bitcoin 3.0 Core version 25.0 is now available from:
...
dbcache, Bitcoin 3.0 Core will now return an error at startup. (#25574)
...
before Bitcoin 3.0 Core has begun its shutdown sequence. (#23395)
