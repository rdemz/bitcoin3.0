# PSBT Howto for Bitcoin 3.0 Core

Since Bitcoin 3.0 Core 0.17, an RPC interface exists for Partially Signed Bitcoin 3.0
...
PSBT is an interchange format for Bitcoin 3.0 transactions that are not fully signed
...
#### Multisig with multiple Bitcoin 3.0 Core instances
...
Bitcoin 3.0 Core. We assume their wallets only contain the multisig funds. In case
...
Later, when *V* BT3 has been received on *Amulti*, and Bob and Carol want to
