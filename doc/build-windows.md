...
Below are some notes on how to build Bitcoin 3.0 Core for Windows.

The options known to work for building Bitcoin 3.0 Core on Windows are:
...
Note that for WSL the Bitcoin 3.0 Core source path MUST be somewhere in the default mount file system, for
