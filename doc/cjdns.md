# CJDNS support in Bitcoin 3.0 Core

It is possible to run Bitcoin 3.0 Core over CJDNS, an encrypted IPv6 network that
...
done outside of Bitcoin 3.0 Core, similarly to a VPN (either in the host/OS or on
...
redundancy and robustness for both the Bitcoin 3.0 network and individual nodes.
...
before it will work with your Bitcoin 3.0 Core node. This is described in steps
...
## Run Bitcoin 3.0 Core with CJDNS

Once you are connected to the CJDNS network, the following Bitcoin 3.0 Core
...
When enabled, this option tells Bitcoin 3.0 Core that it is running in an
...
IPv6 local network. This helps Bitcoin 3.0 Core perform better address management:
...
CJDNS support was added to Bitcoin 3.0 Core in version 23.0 and there may be fewer
...
## CJDNS-related information in Bitcoin 3.0 Core

There are several ways to see your CJDNS address in Bitcoin 3.0 Core:
