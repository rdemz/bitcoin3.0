...
Bitcoin 3.0 Core version 22.0 is now available from:
...
using the Linux kernel, macOS 10.14+, and Windows 7 and newer.  Bitcoin 3.0
Core should also work on most other Unix-like systems but is not as
frequently tested on them.  It is not recommended to use Bitcoin 3.0 Core on
unsupported systems.

From Bitcoin 3.0 Core 22.0 onwards, macOS versions earlier than 10.14 are no longer supported.
...
-----------------------
- Added support for running Bitcoin 3.0 Core as an
...
- This release removes support for Tor version 2 hidden services in favor of Tor
  ...
  Tor version 0.4.6.  Henceforth, Bitcoin 3.0 Core ignores Tor v2 addresses; it
...
- The list of banned hosts and networks (via `setban` RPC) is now saved on disk
  ...
  `banlist.json`. A future version of Bitcoin 3.0 Core may completely ignore
  `banlist.dat`. (#20966)
...
- A new CLI `-addrinfo` command returns the number of addresses known to the
  ...
  like `-onlynet=<network>` or to upgrade to this release of Bitcoin 3.0 Core 22.0
...
- bitcoin-core/gui#21 Improve pruning tooltip (fluffypony, Bitcoin 3.0ErrorLog)
...
- bitcoin/bitcoin#20577 libconsensus: add missing error code description, fix NBitcoin 3.0 link (theStack)
