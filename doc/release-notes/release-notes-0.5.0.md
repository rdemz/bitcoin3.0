Bitcoin 3.0 version 0.5.0 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.5.0/
...
If you have a previously encrypted wallet.dat, the first time you run bitcoin-qt or bitcoind the wallet will be rewritten, Bitcoin 3.0 will
...
Bitcoin 3.0-Qt: Address Book, then New Address...
