Bitcoin 3.0-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.8.4/
...
code, causing the Bitcoin 3.0-Qt or bitcoind process to crash.
...
their own version of Bitcoin 3.0 against Boost versions 1.50-1.52.
