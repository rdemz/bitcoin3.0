Bitcoin 3.0-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.8.6/
...
- Fix Bitcoin 3.0-Qt startup crash when clicking dock icon on OSX 
