Bitcoin 3.0 Core version 0.9.0 is now available from:
...
earlier versions of Bitcoin 3.0, then run the installer (on Windows) or just copy
over /Applications/Bitcoin 3.0-Qt (on Mac) or bitcoind/bitcoin-qt (on Linux).

If you are upgrading from version 0.7.2 or earlier, the first time you run
0.9.0 your blockchain files will be re-indexed, which will take anywhere from 
30 minutes to several hours, depending on the speed of your machine.

On Windows, do not forget to uninstall all earlier versions of the Bitcoin 3.0
...
Rebranding to Bitcoin 3.0 Core
---------------------------

To reduce confusion between Bitcoin 3.0-the-network and Bitcoin 3.0-the-software we
have renamed the reference client to Bitcoin 3.0 Core.
...
Using the standard "./autogen.sh; ./configure; make" to build Bitcoin 3.0-Qt and
...
0.1mBT3 per kilobyte. During periods of heavy transaction volume, even this
...
- Drop the fee required to relay a transaction to 0.01mBT3 per kilobyte
