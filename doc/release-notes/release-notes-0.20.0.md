...
Bitcoin 3.0 Core version 0.20.0 is now available from:
...
#### Removal of BIP61 reject network messages from Bitcoin 3.0 Core

The `-enablebip61` command line option to enable BIP61 has been removed.
(#17004)

This feature has been disabled by default since Bitcoin 3.0 Core version 0.18.0.
...
- Testing or debugging of implementations of the Bitcoin 3.0 P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Bitcoin 3.0 Core. Bitcoin 3.0 Core logs debug messages
...
- OpenSSL is no longer used by Bitcoin 3.0 Core.  (#17265)

- BIP70 support has been fully removed from Bitcoin 3.0 Core. The
...
- All custom settings configured when Bitcoin 3.0 Core starts are now
...
- The "Start Bitcoin 3.0 Core on system login" option has been removed on macOS.
  (#17567)
...
- A "known bug" [announced](https://bitcoincore.org/en/releases/0.18.0/#wallet-gui)
  ...
  affected anyone who simultaneously used multiple Bitcoin 3.0 Core wallets
...
- For watch-only wallets, creating a new transaction in the Send screen
  ...
  automatically copy a Partially-Signed Bitcoin 3.0 Transaction (PSBT) to
  the system clipboard.  This can then be pasted into an external
  program such as [HWI](https://github.com/bitcoin-core/HWI) for
  signing.  Future versions of Bitcoin 3.0 Core should support a GUI option
...
- Bitcoin 3.0 Core's automatically-generated source code documentation is
...
- #16983 Add detailed info about Bitcoin 3.0 Core files (hebasto)
...
- #18341 Replace remaining literal BT3 with `CURRENCY_UNIT` (domob1812)
