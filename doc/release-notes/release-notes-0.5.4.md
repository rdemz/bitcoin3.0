Bitcoin 3.0 version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.5.4/
...
Fix Bitcoin 3.0-Qt notifications under Growl 1.3.
Increase required age of Bitcoin 3.0-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin 3.0 properly when installing Bitcoin 3.0-Qt over it. (Windows)
