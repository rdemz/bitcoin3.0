Download URL: https://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BT3 fee schedule (users still pay 0.01 BT3 per kb, until next version)
