Bitcoin 3.0 Core version 0.16.0 is now available from:
...
Bitcoin 3.0 Core now has more flexibility in where the wallets directory can be
...
------------------------------------
The minimum version of the GCC compiler required to compile Bitcoin 3.0 Core is now 4.8. No effort will be
...
GUI changes
-----------
- Uses of "µBT3" in the GUI now also show the more colloquial term "bits", specified in BIP176.
...
- #12035 `eeb6d52` Change µBT3 to bits (jb55)
