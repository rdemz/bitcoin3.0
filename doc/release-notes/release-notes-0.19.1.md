...
Bitcoin 3.0 Core version 0.19.1 is now available from:
...
From Bitcoin 3.0 Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Bitcoin 3.0 Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Bitcoin 3.0 Core does not yet change appearance when
