Bitcoin 3.0 Core version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer BT3/kB fee to be
...
Block pruning allows Bitcoin 3.0 Core to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that Bitcoin 3.0 Core will 
...
- #5729 `9c4a5a5` Allow unit changes for read-only Bitcoin 3.0AmountField
...
- #6116 `30dc3c1` [OSX] rename Bitcoin 3.0-Qt.app to Bitcoin 3.0-Core.app
