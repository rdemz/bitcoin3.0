Bitcoin 3.0 version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/bitcoin/files/Bitcoin 3.0/bitcoin-0.7.0/

We recommend that everybody running prior versions of bitcoind/Bitcoin 3.0-Qt
...
Bitcoin 3.0 Improvement Proposals implemented
