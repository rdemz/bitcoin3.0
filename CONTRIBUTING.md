Contributing to Bitcoin 3.0 Core
============================

The Bitcoin 3.0 Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Bitcoin 3.0 Core
...
Before you start contributing, familiarize yourself with the Bitcoin 3.0 Core build
system and tests. Refer to the documentation in the repository on how to build
Bitcoin 3.0 Core and how to run the unit tests, functional tests, and fuzz tests.
...
[Bitcoin 3.0 Core PR Review Club](https://bitcoincore.reviews/) meeting.
...
Most communication about Bitcoin 3.0 Core development happens on IRC, in the
...
fork of Bitcoin 3.0 Core copies the merge. Instead, make any username mentions in a
...
The following applies to code changes to the Bitcoin 3.0 Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Bitcoin 3.0
Network Protocol consensus changes.

Whether a pull request is merged into Bitcoin 3.0 Core rests with the project merge
maintainers.
...
Patches that change Bitcoin 3.0 consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoin 3.0 consensus, it must have been
