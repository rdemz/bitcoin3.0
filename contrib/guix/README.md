# Bootstrappable Bitcoin 3.0 Core Builds

This directory contains the files necessary to perform bootstrappable Bitcoin 3.0
Core builds.
...
To build Bitcoin 3.0 Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Bitcoin 3.0 Core version being built.
