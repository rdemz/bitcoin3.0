#!/usr/bin/env python3
# Copyright (c) 2020-2021 The Bitcoin 3.0 Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Script for verifying Bitcoin 3.0 Core release binaries.
...
def verify_shasums_signature(
   ...
   ReturnCode, t.List[SigData], t.List[SigData], t.List[SigData], t.List[SigData]
    ...
    # which pubkeys within the Bitcoin 3.0 community do we trust for the purposes of
    # binary verification?
    trusted_keys = set()
