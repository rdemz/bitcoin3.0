...
Tracing (USDT) support for Bitcoin 3.0 Core on Linux using. For more information on
USDT support in Bitcoin 3.0 Core see the [USDT documentation].
...
[Bitcoin 3.0 Core USDT documentation] on how to list available tracepoints in your
`bitcoind` binary.

[Bitcoin 3.0 Core USDT documentation]: ../../doc/tracing.md#listing-available-tracepoints
...
Bitcoin 3.0 P2P messages can be larger than 32kb (e.g. `tx`, `block`, ...). The
...
In a different terminal, starting Bitcoin 3.0 Core in SigNet mode and with
re-indexing enabled.
