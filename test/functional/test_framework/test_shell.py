#!/usr/bin/env python3
# Copyright (c) 2019-2022 The Bitcoin 3.0 Core developers
...
class TestShell:
    """Wrapper Class for Bitcoin 3.0TestFramework.

    The TestShell class extends the Bitcoin 3.0TestFramework
    ...
    class __TestShell(Bitcoin 3.0TestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by Bitcoin 3.0TestFramework child class.
            self.num_nodes = 1
