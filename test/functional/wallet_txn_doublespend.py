...
class TxnMallTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BT3:
        ...
        # First: use raw transaction API to send 1240 BT3 to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BT3 coin each
        ...
        # Node0's balance should be starting balance, plus 50BT3 for another
        ...
        # Node0's total balance should be starting balance, plus 100BT3 for
