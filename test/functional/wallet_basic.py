...
class WalletTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BT3 from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BT3 with subtract fee from amount
        ...
        # Sendmany 10 BT3 with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid Bitcoin 3.0 address
            assert_raises_rpc_error(-5, "Invalid Bitcoin 3.0 address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid Bitcoin 3.0 address
            assert_raises_rpc_error(-5, "Invalid Bitcoin 3.0 address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid Bitcoin 3.0 address or script", self.nodes[0].importaddress, "invalid")
