...
class ScantxoutsetTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        ...
        # Note that all amounts in the UTXO set are powers of 2 multiplied by 0.001 BT3, so each amounts uniquely identifies a subset.
