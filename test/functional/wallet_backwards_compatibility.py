...
class BackwardsCompatibilityTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        ...
        if self.options.descriptors:
            ...
            node_v17.assert_start_raises_init_error(["-wallet=w3"], "Error: Error loading w3: Wallet requires newer version of Bitcoin 3.0 Core")
        ...
        if self.is_bdb_compiled():
            ...
            # Copy the 0.16 wallet to the last Bitcoin 3.0 Core version and open it:
            shutil.copyfile(
            ...
            # Copy the 0.17 wallet to the last Bitcoin 3.0 Core version and open it:
            ...
            # Copy the 0.19 wallet to the last Bitcoin 3.0 Core version and open it:
            shutil.copytree(
