...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the Bitcoin 3.0TestFramework
    pass


class ExampleTest(Bitcoin 3.0TestFramework):
    # Each functional test is a subclass of the Bitcoin 3.0TestFramework class.
    ...
    def custom_method(self):
        ...
        Bitcoin 3.0TestFramework class so other tests can use it."""
