#!/usr/bin/env python3
# Copyright (c) 2018-2021 The Bitcoin 3.0 Core developers
...
from test_framework.test_framework import Bitcoin 3.0TestFramework, initialize_datadir


class BlocksdirTest(Bitcoin 3.0TestFramework):
