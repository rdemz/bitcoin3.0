...
class WalletLabelsTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        ...
        # each with 1 address with a balance of 50 Bitcoin 3.0s
        ...
        if self.options.descriptors:
            ...
            for l in BECH32_INVALID:
                ...
                assert_raises_rpc_error(
                    -5,
                    "Address is not valid" if self.options.descriptors else "Invalid Bitcoin 3.0 address or script",
