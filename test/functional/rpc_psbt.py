...
class PSBTTest(Bitcoin 3.0TestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BT3
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BT3/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")
